    ...
    if (ModuleBase::GlobalFunc::SCAN_LINE_BEGIN(ifpos, "ATOMIC_POSITIONS"))
    {
        ...
        for (int it = 0; it < ntype; it++)
        {
            ...
            else if (na == 0)
            {
                ...
                std::cout << " If you are confident that this is not a mistake, please ignore this warning."
                          << std::endl;
                std::cout << "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
                          << std::endl;
                ofs_running << "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
                ...
                ofs_running << " If you are confident that this is not a mistake, please ignore this warning."
                            << std::endl;
                ofs_running << "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
                            << std::endl;
            }
            else if (na > 0)
            {
                ...
                for (int ia = 0; ia < na; ia++)
                {
                    ...
                    while ((tmpid != "\n") && (ifpos.good()) && (tmpid != "#"))
                    {
                        ...
                        {
                            ifpos >> ucell.atoms[it].vel[ia].x >> ucell.atoms[it].vel[ia].y
                                >> ucell.atoms[it].vel[ia].z;
                        }
                        else if (tmpid == "mag" || tmpid == "magmom")
                        {
                            ...
                            if ((tmp >= 48 && tmp <= 57) or tmp == '-')
                            {
                                ...
                                ucell.atoms[it].mag[ia]
                                    = sqrt(pow(ucell.atoms[it].m_loc_[ia].x, 2) + pow(ucell.atoms[it].m_loc_[ia].y, 2)
                    ...
                    { // angle1 or angle2 are given, calculate mx, my, mz from angle1 and angle2 and mag
                        ucell.atoms[it].m_loc_[ia].z = ucell.atoms[it].mag[ia] * cos(ucell.atoms[it].angle1[ia]);
                        if (std::abs(sin(ucell.atoms[it].angle1[ia])) > 1e-10)
                        {
                            ucell.atoms[it].m_loc_[ia].x = ucell.atoms[it].mag[ia] * sin(ucell.atoms[it].angle1[ia])
                                                           * cos(ucell.atoms[it].angle2[ia]);
                            ucell.atoms[it].m_loc_[ia].y = ucell.atoms[it].mag[ia] * sin(ucell.atoms[it].angle1[ia])
                                                           * sin(ucell.atoms[it].angle2[ia]);
                        }
                    }
                    ...
                    { // mx, my, mz are given, calculate angle1 and angle2 from mx, my, mz
                        ...
                        if (mxy > 1e-8)
                        {
                            ucell.atoms[it].angle2[ia]
                                = atan2(ucell.atoms[it].m_loc_[ia].y, ucell.atoms[it].m_loc_[ia].x);
                        }
                    }
                    ...
                    if (PARAM.inp.nspin == 4)
                    {
                        ...
                        if (ia == 0
                            || (ucell.atoms[it].m_loc_[ia].x != ucell.atoms[it].m_loc_[0].x
