...
bool init_exx_info(Exx_Info& exx_info, const Input_para& inp)
{
        ...
        )
    {
        ...
        exx_info.info_ri.V_threshold_long = inp.exx_v_threshold_long;
        exx_info.info_ri.V_cd_threshold = inp.exx_vcd_threshold;
        exx_info.info_ri.V_cd_stats_only = inp.exx_vcd_stats_only;
        exx_info.info_ri.V_cd_short_only = inp.exx_vcd_short_only;
        ...
        exx_info.info_ri.ewald_lambda = inp.exx_ewald_lambda;
        exx_info.info_ri.ewald_tail_check = inp.exx_ewald_tail_check;
        exx_info.info_ri.ewald_tail_abs_tol = inp.exx_ewald_tail_abs_tol;
        exx_info.info_ri.ewald_tail_rel_tol = inp.exx_ewald_tail_rel_tol;
        exx_info.info_ri.ewald_tail_sum_rel_tol = inp.exx_ewald_tail_sum_rel_tol;
        exx_info.info_ri.ewald_tail_guard_cells = inp.exx_ewald_tail_guard_cells;
        exx_info.info_ri.ewald_tail_max_expansions = inp.exx_ewald_tail_max_expansions;
