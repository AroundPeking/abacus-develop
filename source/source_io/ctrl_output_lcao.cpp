                      ...
                      const int istep)
{
    ...
    if (PARAM.inp.out_dm1)
    {
        ...
        ModuleIO::write_dmr(dmr_vector, pv, out_app_flag, ucell.get_iat2iwt(), ucell.nat, istep);
    }
    ...
    if (PARAM.inp.out_dm)
    {
        ...
        ModuleIO::write_dmk(pelec->get_DM()->get_DMK_vector(), precision, efermis, &(ucell), pv);
    }
    ...
    {
        ModuleIO::AngularMomentumCalculator mylcalculator(PARAM.inp.orbital_dir,
                                                          ucell,
                                                          ...
                                                          &GlobalV::ofs_running,
                                                          GlobalV::MY_RANK);
        mylcalculator.calculate(PARAM.inp.suffix, global_out_dir, ucell, PARAM.inp.out_mat_l[1], GlobalV::MY_RANK);
    }
    ...
    {
        ModuleIO::cal_mag(&pv, p_hamilt, kv, pelec, two_center_bundle, orb, ucell, gd, istep, true);
    }
