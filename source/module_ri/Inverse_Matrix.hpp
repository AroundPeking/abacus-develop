...
/*
template <>
void Inverse_Matrix<double>::using_syev()
{
     const double& threshold_condition_number = PARAM.inp.Cs_inv_thr;
...
template <>
void Inverse_Matrix<std::complex<double>>::using_syev()
{
    std::cout << "Error: No complex using_syev!" << std::endl;
}
*/
