...
class LapackConnector
{
  private:
    ...
    static inline std::complex<double>* transpose(const ModuleBase::ComplexMatrix& a, const int n, const int lda)
    {
    ...
    static inline std::complex<float>* transpose(const std::complex<float>* a,
                                                 const int n,
                                                 const int lda,
                                                 const int nbase_x)
    {
    ...
    static inline std::complex<double>* transpose(const std::complex<double>* a,
                                                  const int n,
                                                  const int lda,
                                                  const int nbase_x)
    {
    ...
    static inline void transpose(const std::complex<double>* aux,
    ...
    // Transpose the fortran-form real-std::complex array to the std::complex matrix.
    static inline void transpose(const std::complex<float>* aux,
                                 std::complex<float>* a,
                                 const int n,
                                 const int lda,
                                 const int nbase_x)
    ...
    static inline char change_trans_NC(const char& trans)
    {
        switch (trans)
        {
        case 'N':
        ...
        case 'C':
            return 'N';
        default:
            throw std::invalid_argument("trans must be 'N' or 'C'");
        }
    }

  public:
    // wrap function of fortran lapack routine dsyev.
    static inline void dsyev(const char jobz,
                             const char uplo,
                             ModuleBase::matrix& a,
                             double* w,
                             int info) // Peize Lin update 2017-10-17
    {
        assert(a.nr == a.nc);
    ...
    static inline void zheev(const char jobz,
                             const char uplo,
                             const int n,
                             ModuleBase::ComplexMatrix& a,
                             const int lda,
    ...
    static inline void zgetrf(int m, int n, ModuleBase::ComplexMatrix& a, const int lda, int* ipiv, int* info)
    {
        std::complex<double>* aux = LapackConnector::transpose(a, n, lda);
    ...
    static inline void zgetri(int n,
                              ModuleBase::ComplexMatrix& a,
                              int lda,
                              int* ipiv,
                              std::complex<double>* work,
    ...
    static inline void potrf(const char& uplo, const int& n, float* const A, const int& lda, int& info)
    {
        const char uplo_changed = change_uplo(uplo);
        spotrf_(&uplo_changed, &n, A, &lda, &info);
    }
    static inline void potrf(const char& uplo, const int& n, double* const A, const int& lda, int& info)
    {
        const char uplo_changed = change_uplo(uplo);
        dpotrf_(&uplo_changed, &n, A, &lda, &info);
    }
    static inline void potrf(const char& uplo, const int& n, std::complex<float>* const A, const int& lda, int& info)
    {
        const char uplo_changed = change_uplo(uplo);
        cpotrf_(&uplo_changed, &n, A, &lda, &info);
    }
    static inline void potrf(const char& uplo, const int& n, std::complex<double>* const A, const int& lda, int& info)
    {
        const char uplo_changed = change_uplo(uplo);
    ...
    // Peize Lin add 2016-07-09
    static inline void potri(const char& uplo, const int& n, float* const A, const int& lda, int& info)
    {
        const char uplo_changed = change_uplo(uplo);
        spotri_(&uplo_changed, &n, A, &lda, &info);
    }
    static inline void potri(const char& uplo, const int& n, double* const A, const int& lda, int& info)
    {
        const char uplo_changed = change_uplo(uplo);
        dpotri_(&uplo_changed, &n, A, &lda, &info);
    }
    static inline void potri(const char& uplo, const int& n, std::complex<float>* const A, const int& lda, int& info)
    {
        const char uplo_changed = change_uplo(uplo);
        cpotri_(&uplo_changed, &n, A, &lda, &info);
    }
    static inline void potri(const char& uplo, const int& n, std::complex<double>* const A, const int& lda, int& info)
    {
        const char uplo_changed = change_uplo(uplo);
    ...
    // Peize Lin add 2016-07-09
    static inline void potrf(const char& uplo, const int& n, ModuleBase::matrix& A, const int& lda, int& info)
    {
        potrf(uplo, n, A.c, lda, info);
    }
    static inline void potrf(const char& uplo, const int& n, ModuleBase::ComplexMatrix& A, const int& lda, int& info)
    {
        potrf(uplo, n, A.c, lda, info);
    }

    // Peize Lin add 2016-07-09
    static inline void potri(const char& uplo, const int& n, ModuleBase::matrix& A, const int& lda, int& info)
    {
        potri(uplo, n, A.c, lda, info);
    }
    static inline void potri(const char& uplo, const int& n, ModuleBase::ComplexMatrix& A, const int& lda, int& info)
    {
        potri(uplo, n, A.c, lda, info);
    }
    ...
    static inline void herk(const char uplo,
                            const char trans,
                            const int n,
                            const int k,
                            const double alpha,
